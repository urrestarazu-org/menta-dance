 ...
 * arbitrary professor — an INSTRUCTOR creating or editing a course is always
 * its own professor. Rejecting explicitly (rather than silently overriding)
 * makes a client's mistaken or malicious payload visible instead of masked.
 */
