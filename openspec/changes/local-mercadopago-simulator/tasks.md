...
- [x] **1.1** Define failing profile-selection tests
...
- [x] **1.2** Implement the guarded local provider store and two port adapters
...
- [x] **2.1** Specify failing tests for outcome preparation and signatures
...
- [x] **2.2** Add a profile-only preparation boundary
...
- [x] **3.1** Add Bruno payment journey
